...
export default function Home() {
  ...
  style={{
    WebkitTextStroke: '1px black', // stroke hitam
    color: 'white', // isi teks putih agar kontras
  }}
>
  <Typewriter
  ...
  />
        ...
        <div id="about" className="mt-20 max-w-2xl mx-auto text-center px-4 sm:px-6">
          ...
          />
          <div className="text-base sm:text-lg text-gray-700 dark:text-gray-300 border p-6 rounded-2xl bg-white dark:bg-gray-800 transition-transform duration-300 hover:scale-[1.02] shadow-[0_10px_30px_rgba(0,0,0,0.2)] hover:shadow-[0_15px_35px_rgba(0,0,0,0.3)]">
            <Typewriter
              words={[
        ...
        {/* Social Media */}
        <div id="social-media" className="mt-20 text-center animate-fade-in-down shadow-[0_10px_25px_rgba(0,0,0,0.2)] rounded-xl p-6 bg-transparent dark:bg-transparent max-w-4xl mx-auto">
